  ...
  <div class="ibox ">
    <div class="ibox-content">
      <div class="row">
          ...
          <form method="post" class="form-horizontal form-label-left" action="<?php echo base_url('terms/store'); ?>">
            <div class="col-md-12">
            <div class="form-group">
              <label>Terms and Condition</label> 
              <?php echo form_textarea(['name' =>'terms','id' =>'terms','class'=>'form-control summernote', 'placeholder'=> 'write here your terms and conditions','style' => "width:100%"]); ?>
