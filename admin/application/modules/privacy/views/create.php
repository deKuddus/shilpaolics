  ...
  <div class="ibox ">
    <div class="ibox-content">
      <div class="row">
          ...
          <form method="post" class="form-horizontal form-label-left" action="<?php echo base_url('privacy/store'); ?>">
            <div class="col-md-12">
            <div class="form-group">
              <label>Privacy & Policy</label> 
              <?php echo form_textarea(['name' =>'privacy','id' =>'privacy','class'=>'form-control summernote', 'placeholder'=> 'write here your privacy and conditions','style' => "width:100%"]); ?>
