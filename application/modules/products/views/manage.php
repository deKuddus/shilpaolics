...
<div class="breadcumb_area">
  <div class="container h-100">
    <div class="row h-100 align-items-center">
      <div class="col-12">
        <h5>Product in Category</h5>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo base_url('product') ?>">Home</a></li>
      ...
      <div class="col-12 col-sm-7 col-md-8 col-lg-9">
        ...
        <div class="shop_top_sidebar_area d-flex flex-wrap align-items-center justify-content-between">
          <div class="view_area d-flex">
           ...
           <?php if($new != 1): ?>
            <select class="small right common_selector" name="">
        ...
        <div class="shop_grid_product_area">
           <?php if(!isset($newarraival)): ?>
          <div class="row justify-content-center" id="load_data">
        ...
        <?php endif ?>
          ...
          <div class="row justify-content-center">
            ...
            $discount_type = get_discount_type();
             foreach ($newarraival as $key => $product) { ?>
